...
function applyMerge<TValue extends OnyxInput<OnyxKey> | undefined, TChange extends OnyxInput<OnyxKey> | undefined>(
    ...
    if (changes.some((change) => change && typeof change === 'object')) {
	  ...
	  testt ?  console.log('changes.........: ', changes)  : null;
        return changes.reduce((modifiedData, change) => utils.fastMerge(modifiedData, change, shouldRemoveNestedNulls, testt), (existingValue || {}) as TChange);
    }
